...
//   Each variant should contain a string with the explanation of what went wrong 
//   exactly. You'll have to update the implementation of `Ticket::new` as well.
#[derive(Debug)]
enum TicketNewError {
    TitleError(String),
...
fn easy_ticket(
    title: String, description: String, status: Status) -> Ticket {
