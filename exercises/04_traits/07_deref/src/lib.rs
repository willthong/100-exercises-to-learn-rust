// TODO: whenever `title` and `description` are returned via their accessor methods, 
// they should be normalized—i.e. leading and trailing whitespace should be removed.
